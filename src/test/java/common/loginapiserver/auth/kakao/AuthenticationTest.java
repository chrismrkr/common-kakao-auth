package common.loginapiserver.auth.kakao;
...
public class AuthenticationTest {
    ...
    void success() throws Exception {
        ...
        // when
        ResultActions perform = mockMvc.perform(get("/oauth2/authorize/kakao")
                        .cookie(cookie)
                )
        ...
        // when
        ResultActions perform2 = mockMvc.perform(get("/login/oauth2/kakao")
                        .queryParams(queryParams)
                        .cookie(cookie))
                .andExpect(MockMvcResultMatchers.status().is3xxRedirection());

        // then
        MvcResult result = perform2.andReturn();
